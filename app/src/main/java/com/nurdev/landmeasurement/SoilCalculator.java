...
public class SoilCalculator extends AppCompatActivity {
    private EditText l1f,l1e,l2f,l2e,p1f,p1e,p2f,p2e,h1,h2;
    private TextView error,result;
    private Button resultbtn,clearbtn;
    double len1F,len2F,len1i,len2i,pr1f,pr1i,pr2f,pr2i,khetrofol,LengthF,LengthI,ProF,ProI,h1I,h2I;
  //  private AdView mAdView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("ইট, পাথর, বালু পরিমাপ ক্যালকুলেটর");
        setContentView(R.layout.activity_soil_calculator);
...
*/
    ...
    /*    mAdView = findViewById(R.id.adView);
        ...
        h1=(EditText)findViewById(R.id.h1Id);
        h2=(EditText)findViewById(R.id.h2Id);
        ...
        resultbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if(TextUtils.isEmpty(h1.getText().toString()) )
                {
                    error.setText("উচ্চতা  ইনপুট-১ দেখুন !");
                }
                else if(TextUtils.isEmpty(h2.getText().toString()))
                {
                    error.setText("উচ্চতা ইনপুট-২ দেখুন !");
                }
                else {
                    ...
                    h1I = Double.parseDouble(h1.getText().toString());
                    h2I = Double.parseDouble(h2.getText().toString());
                    ...
                    khetrofol = (LengthF+LengthI)*(ProF+ProI)*((h1I+h2I)/24);


                    error.setText("");
                    result.setText(String.format("%.2f",khetrofol)+" সিএফটি ");
                }
